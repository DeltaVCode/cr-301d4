...
function displayPics(){
  ...
  /*Since const rando is declared inside of a function it is a local variable and is not able to be used
  outside of the function.  Thus when we console.log it, it comes up as an error.
  */
  console.log(viewed);
